...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=travel-planning-agent,service.version={commit_sha}",
        )
...
def setup_agent_engine_telemetry() -> None:
    ...
    try:
        ...
        logging.warning(
            f"Could not initialize Agent Engine telemetry: {e}. Telemetry is disabled for local runs."
        )
